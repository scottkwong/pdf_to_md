"""
Tests for digital text parser benchmark behavior.
...
from benchmark_digital_text_parsers import benchmark_digital_text_parsers
...
def test_benchmark_uses_default_generated_fixtures() -> None:
    ...
    summary = benchmark_digital_text_parsers(runs=1, pdf_path=None)
